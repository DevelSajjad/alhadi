      ...
      <div class="ms-panel">
        ...
        <div class="ms-panel-body">
          ...
          <div class="form-group text-right">
            <a href="{{ route('admin.privacy.update') }}" class="pull-right btn btn-outline-success btn-sm mb-2">Update Privacy & Policy</a>
          </div>
          <div class="col-md-12">
            <h2 class="db-header-title" id="title">{{$privacy-> title_en}}</h2>
          </div>
          <div class="col-md-12 mb-40">
            <h3>Overview</h3>
            <span id="overview">{!! $privacy-> overview !!}</span>
          </div>

          <div class="col-md-12">
            <h3>Privacy & Policy</h3>
            <span id="description">{!! $privacy-> description !!}</span>
          </div>
        </div>
      </div>
    </div>
