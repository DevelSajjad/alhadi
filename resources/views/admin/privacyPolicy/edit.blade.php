...
@section('content')
  <div class="row">
    <div class="col-md-12">
      <h1 class="db-header-title">Update Privacy & Policy</h1>
    </div>
    <div class="col-12">
      <div class="ms-panel">
      ...
      <div class="ms-panel">
        ...
        <div class="ms-panel-body">
          <div class="form-group text-right">
            <a href="{{ route('admin.privacy.view') }}" class="btn btn-outline-success btn-sm mb-2">View Privacy & Policy</a>
          </div>
          <form action="{{ route('admin.privacy.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" id="title_en" placeholder="Enter  title [EN]" value="{{old('title_en', $privacy-> title_en)}}" required name="title_en"  class="form-control @error('title_en') is-invalid @enderror">
              @error('title_en')
            ...
            {{-- <div class="form-group">
              ...
              <input type="text" id="title_bn" placeholder="Enter  title [BN]" value="{{old('title_bn', $policy-> title_bn)}}" required name="title_bn" class="form-control @error('title_bn') is-invalid @enderror">
              @error('title_bn')
            ...
            <div class="form-group">
              <label for="summernote_overview">Overview [EN] <span class="text-danger">*</span></label>
              <textarea id="summernote_overview" name="overview" required>{{ $privacy->overview }}</textarea>
              @error('overview')
            ...
            <div class="form-group">
              ...
              <textarea id="summernote" name="description" required>{{ $privacy->description }}</textarea>
              @error('description')
            ...
            {{-- <div class="form-group">
              ...
              <textarea id="summernote1" name="description_bn" required>{{ $policy-> description_bn }}</textarea>
