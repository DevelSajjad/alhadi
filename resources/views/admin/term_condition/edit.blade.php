...
@section('content')
  <div class="row">
    <div class="col-md-12">
      <h1 class="db-header-title">Update Terms & Condition</h1>
    </div>
    <div class="col-12">
      <div class="ms-panel">
      ...
      <div class="ms-panel">
        ...
        <div class="ms-panel-body">
          <div class="form-group text-right">
            <a href="{{ route('admin.term.view') }}" class="btn btn-outline-success btn-sm mb-2">View Terms & Condition</a>
          </div>
          <form action="{{ route('admin.term.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" id="title_en" placeholder="Enter  title [EN]" value="{{old('title_en', $term-> title_en)}}" required name="title_en"  class="form-control @error('title_en') is-invalid @enderror">
              @error('title_en')
            ...
            <div class="form-group">
              ...
              <textarea id="summernote_overview" name="overview" required>{{ $term->overview }}</textarea>
              @error('overview')
            ...
            <div class="form-group">
              ...
              <textarea id="summernote" name="description" required>{{ $term->description }}</textarea>
              @error('description')
