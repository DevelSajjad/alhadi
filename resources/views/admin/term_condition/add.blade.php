...
@section('content')
  <div class="row">
    <div class="col-md-12">
      <h1 class="db-header-title">Add Terms and Condition</h1>
    </div>
    <div class="col-12">
      <div class="ms-panel">
      ...
      <div class="ms-panel">
        ...
        <div class="ms-panel-body">
          <form action="{{ route('admin.term.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label for="summernote">Overview [EN] <span class="text-danger">*</span></label>
              <textarea id="summernote_overview" name="overview" required>{{ old('overview') }}</textarea>
              @error('overview')
  ...
  <script>
    $(document).ready(function () {
      $('#summernote_overview').summernote({
        placeholder: 'Write terms & condition [EN]',
        tabsize: 2,
        height: 120,
      });
